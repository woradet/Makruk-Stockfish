...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   ...
   { S( -33,16), S(-43,125), S(  4,150), S(  4,175) },
   { S( -44,26), S(-22,150), S( 90,180), S(200,200) },
   { S(  -1,26), S( 18,150), S(133,180), S(200,200) },
   { S(   7,26), S( 16,150), S(128,180), S(200,200) },
   { S(  11,26), S( 37,150), S(146,180), S(200,200) },
   { S( -63,16), S( 20,125), S(  5,150), S( 14,175) },
   { S(-120, 0), S(-57, 16), S(-32, 28), S(-20, 30) }
  },
  { // Bishop
   { S(-100, 0), S(-76, 16), S(-60, 28), S(-53, 30) },
   { S( -63,16), S(-33,125), S(  4,150), S(  3,175) },
   { S(   7,26), S( 22,150), S( 90,180), S( 99,200) },
   { S(   8,26), S( 28,150), S(133,180), S(200,200) },
   { S(   9,26), S( 36,150), S(128,180), S(200,200) },
   { S(  11,26), S( 47,150), S(146,180), S(200,200) },
   { S( -50,16), S( 29,125), S(  5,150), S( 14,175) },
   { S(-120, 0), S(-57, 16), S(-32, 28), S(-20, 30) }
  },
  { // Knight
