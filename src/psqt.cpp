...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   ...
   { S( -33,16), S(-43, 25), S(  4, 50), S(  4, 75) },
   { S( -44,26), S(-22, 50), S( 90, 80), S(200,100) },
   { S(  -1,26), S( 18, 50), S(133, 80), S(200,100) },
   { S(   7,26), S( 16, 50), S(128, 80), S(200,100) },
   { S(  11,26), S( 37, 50), S(146, 80), S(200,100) },
   { S( -63,16), S( 20, 25), S(  5, 50), S( 14, 75) },
   { S(-120, 0), S(-57, 16), S(-32, 28), S(-20, 30) }
  },
  { // Bishop
   { S(-100, 0), S(-76, 16), S(-60, 28), S(-53, 30) },
   { S( -63,16), S(-33, 25), S(  4, 50), S(  3, 75) },
   { S(   7,26), S( 22, 50), S( 90, 80), S( 99,100) },
   { S(   8,26), S( 28, 50), S(133, 80), S(200,100) },
   { S(   9,26), S( 36, 50), S(128, 80), S(200,100) },
   { S(  11,26), S( 47, 50), S(146, 80), S(200,100) },
   { S( -50,16), S( 29, 25), S(  5, 50), S( 14, 75) },
   { S(-120, 0), S(-57, 16), S(-32, 28), S(-20, 30) }
  },
  { // Knight
